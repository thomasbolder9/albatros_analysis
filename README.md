...
This branch is in large part a copy of the dev branch written by Mohan, which is operated by Thomas. It is to work on, in part, the satelite detection script.
